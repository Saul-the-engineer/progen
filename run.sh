...
#    GITHUB_USERNAME - name of my github user, e.g. Saul-the-engineer
...
EOF
    ...
    if [[ -n "$GH_TOKEN" ]]; then
        git remote set-url origin "https://$GITHUB_USERNAME:$GH_TOKEN@github.com/Saul-the-engineer/$REPO_NAME"
    fi
